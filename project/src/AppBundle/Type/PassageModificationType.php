...
class PassageModificationType extends AbstractType
{
    protected $dm;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        if(!$builder->getData()->getRendezVous()) {
            $builder->add('datePrevision', DateType::class, array(
                "attr" => array(
