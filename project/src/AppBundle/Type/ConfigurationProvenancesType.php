...
class ConfigurationProvenancesType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $builder->add('provenances', CollectionType::class, array(
            'entry_type' => new ConfigurationProvenanceType($this->container, $this->dm),
            'allow_add' => true,
            'allow_delete' => true,
            'delete_empty' => true,
            'label' => ' ',
