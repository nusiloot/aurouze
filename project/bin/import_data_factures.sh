...
join -t ';' -1 1 -2 2 $DATA_DIR/factures.cleaned.sorted.csv  $DATA_DIR/factureslignes.cleaned.sorted.csv -o auto | sort -t ";" -n -k 1,1 | sed 's|#$||'| awk -F ';' '{
     if($2 && $8 && ($9 !~ " (2013|2014|2015|2016|2017) " && $2 !~ "^(2013|2014|2015|2016|2017)")) { next }
     if($2 && !$8 && $9 !~ " (2014|2015|2016|2017) " && $2 !~ "^(2014|2015|2016|2017)") { next }
     print $0;
 }' > $DATA_DIR/factures_complets.csv
