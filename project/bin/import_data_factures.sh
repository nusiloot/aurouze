...
join -t ';' -1 1 -2 2 $DATA_DIR/factures.cleaned.sorted.csv  $DATA_DIR/factureslignes.cleaned.sorted.csv -o auto | awk -F ';' '{ if($2 && $8 && ($9 !~ " (2012|2013|2014|2015|2016) " && $2 !~ "^(2012|2013|2014|2015|2016)")) { next } if($2 && !$8 && $9 !~ " (2013|2014|2015|2016) " && $2 !~ "^(2013|2014|2015|2016)") { next } print $0; }' | sort -t ";" -n -k 1,1 | less
vince@vince-dell:~/www/aurouze/project$ join -t ';' -1 1 -2 2 $DATA_DIR/factures.cleaned.sorted.csv  $DATA_DIR/factureslignes.cleaned.sorted.csv -o auto | awk -F ';' '{
